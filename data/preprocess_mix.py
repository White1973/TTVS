...
def make_map_fn(split, source=None):
        def process_fn(example, idx):
            ...
            question_aug = example.pop("prompt_aug")
...
if __name__ == '__main__':
    ...
    train_dataset = datasets.load_dataset("json", data_files=os.path.join(data_source, 'train_mix_new.json'), split='train')
    ...
    train_dataset.to_parquet(os.path.join(data_source, 'train_mix_new.parquet'))
